						...
						<form method="post" id="sign_event" enctype="multipart/form-data">
							...
							<fieldset>
								<div class="form-group">
									<label for="eno" class="col-sm-2 control-label">이벤트 번호</label>
									<input type="text" name="eno" id="eno" class="form-control"
										value="${param.eno}" readonly>
								</div>
								...
								<div class="form-group">
									<label for="edate" class="col-sm-2 control-label">작성일자
									</label> <input type="date" name="edate" id="edate"
										class="form-control" value="${param.edate}" readonly>


								</div>
								<div class="form-group">
									<label for="etarget" class="col-sm-2 control-label">이벤트
										대상</label> <input type="text" name="etarget" id="etarget"
										class="form-control">
								</div>
								<div class="form-group">
									<label for="etype" class="col-sm-2 control-label">이벤트
										타입</label> <input type="radio" name="etype" id="etype" value="기획전">기획전
									<input type="radio" name="etype" id="etype" value="할인전">할인전
								</div>
								...
								<div class="inputArea">
									<label for="eimg">사진</label> <input type="file"
										name="multipartFile" id="eimg">
									<div class="select_img">
										<img src="${pageContext.request.contextPath}/${eventDTO.eimg}" />
										<input type="hidden" name="eimg" value="${eventDTO.eimg}" />
										<input type="hidden" name="efile" value="${eventDTO.efile}" />
									</div>
								...
								<div class="form-group" style="margin-top: 50px;">
									...
									<button type="button" class="btn-b" onclick="history()">취소</button>
									<button type="button" class="btn-a" style="margin-left: 340px;"
