...
<div>
<h2 style="border-bottom: 1px solid lightgray"> 회원 수정 정보 </h2>
</div>
...
<tbody>
		...
		<tr>
			...
			<td>${memberDTO2.mpw}</td>
			<td>${memberDTO2.mgender}</td>
			<td>${memberDTO2.memail}</td>
			<td>${memberDTO2.mphonenum}</td>
		</tr>
...
<div>
	<a href="./MemberInquiryAll"> 회원 관리 </a>
</div>
<div>
	<a href="./MemberDelete?mid=${memberDTO.mid}"> 회원 삭제 </a>
</div>
