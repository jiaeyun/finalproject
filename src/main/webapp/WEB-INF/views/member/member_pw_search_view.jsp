...
<div style="text-align: center; margin: auto; width: 1200px; height: 200px; margin-top: 80px;">
	...
	<div>
	회원님의 임시 비밀번호는 &nbsp;<font style="color: blue;">${pwCode}</font>&nbsp; 입니다, 로그인 후 비밀번호를 변경해주세요.
	</div>
	...
	<button class="default-btn" type="button" style="cursor: pointer;" onclick="location.href='./MemberIdSearch'">아이디 찾기</button>
	</div>
